    ...
    OperationMapper.prototype.getDtypeParam = function (attrs, name, def) {
        ...
        if (param && param.type) {
            ...
            if (typeof (param.type) === 'string') {
                type = compiled_api_json_1.tensorflow_json.DataType[param.type];
            }
            switch (type) {
                case compiled_api_json_1.tensorflow_json.DataType.DT_FLOAT:
                    return 'float32';
                case compiled_api_json_1.tensorflow_json.DataType.DT_INT32:
                    return 'int32';
                case compiled_api_json_1.tensorflow_json.DataType.DT_BOOL:
                    return 'bool';
                default:
                    return def;
            }
...
//# sourceMappingURL=operation_mapper_json.js.map