...
function expectArraysClose(actual, expected, epsilon) {
    ...
    var exp = typeof expected === 'number' || typeof expected === 'boolean' ?
        [expected] :
        expected;
    return expectArraysPredicate(actual, exp, function (a, b) { return areClose(a, Number(b), epsilon); });
}
...
function expectArraysEqual(actual, expected) {
    ...
    if (actual instanceof tensor_1.Tensor && actual.dtype === 'string' ||
        ...
        Array.isArray(actual) && util_1.isString(actual[0]) ||
        Array.isArray(expected) && util_1.isString(expected[0])) {
