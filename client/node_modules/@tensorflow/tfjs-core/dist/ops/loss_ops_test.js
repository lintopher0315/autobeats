...
jasmine_util_1.describeWithFlags('computeWeightedLoss', test_util_1.ALL_ENVS, function () {
    it('1D - no weights', function () {
        ...
        test_util_1.expectArraysClose(y, (1 + 2 + 3) / 3);
    });
    ...
    it('1D - weights', function () {
        ...
        expect(y.shape).toEqual([]);
        test_util_1.expectArraysClose(y, (1 * 0.1 + 2 * 0 + 3 * 0.3) / 2);
    });
    it('2D - weights - broadcast', function () {
        ...
        var y = tf.losses.computeWeightedLoss(losses, weights);
        expect(y.shape).toEqual([]);
        test_util_1.expectArraysClose(y, 0.06666667);
    });
    ...
    it('1D - weights - Reduction.MEAN', function () {
        ...
        expect(y.shape).toEqual([]);
        test_util_1.expectArraysClose(y, (1 * 0.1 + 2 * 0.2 + 3 * 0.3) / 0.6);
    });
    ...
    it('2D - no weights', function () {
        ...
        var y = tf.losses.computeWeightedLoss(losses);
        expect(y.shape).toEqual([]);
        test_util_1.expectArraysClose(y, (4 + 8 + 12 + 8 + 1 + 3) / 6);
    });
    it('2D - weights', function () {
        ...
        var y = tf.losses.computeWeightedLoss(losses, weights);
        expect(y.shape).toEqual([]);
        test_util_1.expectArraysClose(y, (4 * 1 + 8 * 0 + 12 * 2 + (8 * -5) + 1 * 0 + 3 * 6) / 4);
    });
    ...
    it('2D - weights - broadcast - MEAN', function () {
        ...
        var y = tf.losses.computeWeightedLoss(losses, weights, tf.Reduction.MEAN);
        expect(y.shape).toEqual([]);
        test_util_1.expectArraysClose(y, (0.3 + 0.1 + 0.2) / (3 * 0.6));
    });
...
jasmine_util_1.describeWithFlags('absoluteDifference', test_util_1.ALL_ENVS, function () {
    it('1D', function () {
        ...
        expect(y.shape).toEqual([]);
        test_util_1.expectArraysClose(y, (Math.abs(1 - 0.3) + Math.abs(2 - (-0.6)) + Math.abs(3 - (-0.1))) / 3);
    });
    it('1D - weighted - Reduction.SUM_BY_NONZERO_WEIGHTS', function () {
        ...
        expect(y.shape).toEqual([]);
        test_util_1.expectArraysClose(y, (Math.abs(1 - 0.3) * 0.1 + Math.abs(2 - (-0.6)) * 0.2 +
            Math.abs(3 - (-0.1)) * 0.3) /
            3);
    });
    ...
    it('2D', function () {
        ...
        var y = tf.losses.absoluteDifference(label, predictions);
        expect(y.shape).toEqual([]);
        test_util_1.expectArraysClose(y, (Math.abs(4 - 1) + Math.abs(8 - 9) + Math.abs(12 - 2) +
    ...
    it('2D - weighted - Reduction.SUM_BY_NONZERO_WEIGHTS', function () {
        ...
        var y = tf.losses.absoluteDifference(label, predictions, weights);
        expect(y.shape).toEqual([]);
        test_util_1.expectArraysClose(y, (Math.abs(4 - 1) * 3 + Math.abs(8 - 9) * 0 + Math.abs(12 - 2) * 5 +
    ...
    it('2D - weighted - Reduction.MEAN', function () {
        ...
        var y = tf.losses.absoluteDifference(label, predictions, weights, tf.Reduction.MEAN);
        expect(y.shape).toEqual([]);
        test_util_1.expectArraysClose(y, (Math.abs(4 - 1) * 3 + Math.abs(8 - 9) * 6 + Math.abs(12 - 2) * 5 +
            Math.abs(8 - (-5)) * 0 + Math.abs(1 - (-2)) * 4 +
            Math.abs(3 - 6) * 2) /
            20);
    });
...
jasmine_util_1.describeWithFlags('meanSquaredError', test_util_1.ALL_ENVS, function () {
    it('1D', function () {
        ...
        expect(y.shape).toEqual([]);
        test_util_1.expectArraysClose(y, ((1 - 0.3) * (1 - 0.3) + (2 - (-0.6)) * (2 - (-0.6)) +
            (3 - (-0.1)) * (3 - (-0.1))) /
            3);
    });
    it('1D - weighted - Reduction.SUM_BY_NONZERO_WEIGHTS', function () {
        ...
        expect(y.shape).toEqual([]);
        test_util_1.expectArraysClose(y, ((1 - 0.3) * (1 - 0.3) * 0.1 + (2 - (-0.6)) * (2 - (-0.6)) * 0.2 +
            (3 - (-0.1)) * (3 - (-0.1)) * 0.3) /
            3);
    });
    it('1D - weighted - Reduction.NONE', function () {
    ...
    it('2D', function () {
        ...
        var y = tf.losses.meanSquaredError(label, predictions);
        expect(y.shape).toEqual([]);
        test_util_1.expectArraysClose(y, ((4 - 1) * (4 - 1) + (8 - 9) * (8 - 9) + (12 - 2) * (12 - 2) +
            (8 - (-5)) * (8 - (-5)) + (1 - (-2)) * (1 - (-2)) +
            (3 - 6) * (3 - 6)) /
            6);
    });
    it('2D - weighted - Reduction.SUM_BY_NONZERO_WEIGHTS', function () {
        ...
        var y = tf.losses.meanSquaredError(label, predictions, weights);
        expect(y.shape).toEqual([]);
        test_util_1.expectArraysClose(y, ((4 - 1) * (4 - 1) * 3 + (8 - 9) * (8 - 9) * 0 +
    ...
    it('2D - weighted - Reduction.MEAN', function () {
        ...
        var y = tf.losses.meanSquaredError(label, predictions, weights, tf.Reduction.MEAN);
        expect(y.shape).toEqual([]);
        test_util_1.expectArraysClose(y, ((4 - 1) * (4 - 1) * 3 + (8 - 9) * (8 - 9) * 6 +
            (12 - 2) * (12 - 2) * 5 + (8 - (-5)) * (8 - (-5)) * 0 +
            (1 - (-2)) * (1 - (-2)) * 4 + (3 - 6) * (3 - 6) * 2) /
            20);
    });
...
jasmine_util_1.describeWithFlags('cosineDistance', test_util_1.ALL_ENVS, function () {
    it('1D', function () {
        ...
        expect(y.shape).toEqual([]);
        test_util_1.expectArraysClose(y, 1 - (1 * 0.3 + 2 * -0.6 + 3 * -0.1));
    });
    it('1D - weighted - Reduction.SUM_BY_NONZERO_WEIGHTS', function () {
        var predictions = tf.tensor1d([1, 2, 3]);
        var label = tf.tensor1d([0.3, -0.6, -0.1]);
    ...
    it('1D - weighted - Reduction.MEAN', function () {
        ...
        expect(y.shape).toEqual([]);
        test_util_1.expectArraysClose(y, ((1 - (1 * 0.3 + 2 * -0.6 + 3 * -0.1)) * 0.1) / 0.1);
    });
    it('2D', function () {
        var predictions = tf.tensor2d([4, 8, 12, 8, 1, 3], [2, 3]);
        var label = tf.tensor2d([1, 9, 2, -5, -2, 6], [2, 3]);
        ...
        expect(y.shape).toEqual([]);
        test_util_1.expectArraysClose(y, ((1 - (4 * 1 + 8 * 9 + 12 * 2)) + (1 - (8 * -5 + 1 * -2 + 3 * 6))) / 2);
    });
    it('2D - weighted - Reduction.SUM_BY_NONZERO_WEIGHTS', function () {
        var predictions = tf.tensor2d([4, 8, 12, 8, 1, 3], [2, 3]);
        var label = tf.tensor2d([1, 9, 2, -5, -2, 6], [2, 3]);
        ...
        expect(y.shape).toEqual([]);
        test_util_1.expectArraysClose(y, ((1 - (4 * 1 + 8 * 9 + 12 * 2)) * 3 +
            (1 - (8 * -5 + 1 * -2 + 3 * 6)) * 0) /
            1);
    });
    it('2D - weighted - Reduction.NONE', function () {
...
jasmine_util_1.describeWithFlags('hingeLoss', test_util_1.ALL_ENVS, function () {
    it('1D', function () {
        ...
        expect(y.shape).toEqual([]);
        test_util_1.expectArraysClose(y, 1.0);
    });
    it('1D - weighted - Reduction.SUM_BY_NONZERO_WEIGHTS', function () {
        var predictions = tf.tensor1d([0, 0, 1, 1]);
        var label = tf.tensor1d([0, 1, 0, 1]);
        ...
        expect(y.shape).toEqual([]);
        test_util_1.expectArraysClose(y, 0.225);
    });
    it('1D - weighted - Reduction.NONE', function () {
        var predictions = tf.tensor1d([0, 0, 1, 1]);
        var label = tf.tensor1d([0, 1, 0, 1]);
    ...
    it('1D - weighted - Reduction.MEAN', function () {
        ...
        expect(y.shape).toEqual([]);
        test_util_1.expectArraysClose(y, 0.9);
    });
    it('2D', function () {
        ...
        var y = tf.losses.hingeLoss(label, predictions);
        expect(y.shape).toEqual([]);
        test_util_1.expectArraysClose(y, 0.8333333);
    });
    it('2D - weighted - Reduction.SUM_BY_NONZERO_WEIGHTS', function () {
        var predictions = tf.tensor2d([0, 0, 0, 1, 1, 1], [2, 3]);
        var label = tf.tensor2d([0, 1, 0, 1, 0, 1], [2, 3]);
        ...
        var y = tf.losses.hingeLoss(label, predictions, weights);
        expect(y.shape).toEqual([]);
        test_util_1.expectArraysClose(y, 0.26666668);
    });
    it('2D - weighted - Reduction.NONE', function () {
        var predictions = tf.tensor2d([0, 0, 0, 1, 1, 1], [2, 3]);
        var label = tf.tensor2d([0, 1, 0, 1, 0, 1], [2, 3]);
    ...
    it('2D - weighted - Reduction.MEAN', function () {
        ...
        var y = tf.losses.hingeLoss(label, predictions, weights, tf.Reduction.MEAN);
        expect(y.shape).toEqual([]);
        test_util_1.expectArraysClose(y, 0.76190484);
    });
    it('throws when passed label as a non-tensor', function () {
...
jasmine_util_1.describeWithFlags('logLoss', test_util_1.ALL_ENVS, function () {
    it('1D', function () {
        ...
        expect(y.shape).toEqual([]);
        test_util_1.expectArraysClose(y, 2.668788);
    });
    ...
    it('1D - weighted - Reduction.SUM_BY_NONZERO_WEIGHTS', function () {
        ...
        expect(y.shape).toEqual([]);
        test_util_1.expectArraysClose(y, 0.7168596);
    });
    it('1D - weighted - Reduction.NONE', function () {
        var labels = tf.tensor1d([1, 2, 3]);
        var predictions = tf.tensor1d([0.3, 0.6, 0.1]);
    ...
    it('1D - weighted - Reduction.MEAN', function () {
        ...
        expect(y.shape).toEqual([]);
        test_util_1.expectArraysClose(y, 3.5842977);
    });
    it('2D', function () {
        ...
        var y = tf.losses.logLoss(labels, predictions);
        expect(y.shape).toEqual([]);
        test_util_1.expectArraysClose(y, 0.60019904);
    });
    it('2D - weighted - Reduction.SUM_BY_NONZERO_WEIGHTS', function () {
        var labels = tf.tensor2d([0.4, 0.8, 0.12, 0.8, 0.1, 0.3], [2, 3]);
        var predictions = tf.tensor2d([0.1, 0.7, 0.1, 0.5, 0.05, 0.15], [2, 3]);
        ...
        var y = tf.losses.logLoss(labels, predictions, weights);
        expect(y.shape).toEqual([]);
        test_util_1.expectArraysClose(y, 1.8866577);
    });
    it('2D - weighted - Reduction.NONE', function () {
        var labels = tf.tensor2d([0.4, 0.8, 0.12, 0.8, 0.1, 0.3], [2, 3]);
        var predictions = tf.tensor2d([0.1, 0.7, 0.1, 0.5, 0.05, 0.15], [2, 3]);
    ...
    it('2D - weighted - Reduction.MEAN', function () {
        ...
        var y = tf.losses.logLoss(labels, predictions, weights, undefined, tf.Reduction.MEAN);
        expect(y.shape).toEqual([]);
        test_util_1.expectArraysClose(y, 0.53904504);
    });
    it('throws when passed label as a non-tensor', function () {
        var predictions = tf.tensor2d([0.1, 0.7, 0.1, 0.5, 0.05, 0.15], [2, 3]);
        var weights = tf.tensor2d([3, 6, 5, 0, 4, 2], [2, 3]);
...
jasmine_util_1.describeWithFlags('huberLoss', test_util_1.ALL_ENVS, function () {
    it('1D', function () {
        ...
        expect(y.shape).toEqual([]);
        test_util_1.expectArraysClose(y, 1.1816667);
    });
    it('1D - delta', function () {
        ...
        expect(y.shape).toEqual([]);
        test_util_1.expectArraysClose(y, 0.58666664);
    });
    it('1D - weighted - Reduction.SUM_BY_NONZERO_WEIGHTS', function () {
        var labels = tf.tensor1d([1, 2, 3]);
        var predictions = tf.tensor1d([0.3, 0.6, 0.1]);
        ...
        expect(y.shape).toEqual([]);
        test_util_1.expectArraysClose(y, 0.30816665);
    });
    it('1D - weighted - Reduction.NONE', function () {
        var labels = tf.tensor1d([1, 2, 3]);
        var predictions = tf.tensor1d([0.3, 0.6, 0.1]);
    ...
    it('1D - weighted - Reduction.MEAN', function () {
        ...
        expect(y.shape).toEqual([]);
        test_util_1.expectArraysClose(y, 1.5408332);
    });
    it('2D', function () {
        var labels = tf.tensor2d([0.4, 0.8, 0.12, 0.8, 0.1, 0.3], [2, 3]);
        var predictions = tf.tensor2d([0.1, 0.7, 0.1, 0.5, 0.05, 0.15], [2, 3]);
        var y = tf.losses.huberLoss(labels, predictions);
        expect(y.shape).toEqual([]);
        test_util_1.expectArraysClose(y, 0.01795);
    });
    it('2D - weighted - Reduction.SUM_BY_NONZERO_WEIGHTS', function () {
        var labels = tf.tensor2d([0.4, 0.8, 0.12, 0.8, 0.1, 0.3], [2, 3]);
        var predictions = tf.tensor2d([0.1, 0.7, 0.1, 0.5, 0.05, 0.15], [2, 3]);
        ...
        var y = tf.losses.huberLoss(labels, predictions, weights);
        expect(y.shape).toEqual([]);
        test_util_1.expectArraysClose(y, 0.040875003);
    });
    it('2D - weighted - Reduction.NONE', function () {
        var labels = tf.tensor2d([0.4, 0.8, 0.12, 0.8, 0.1, 0.3], [2, 3]);
        var predictions = tf.tensor2d([0.1, 0.7, 0.1, 0.5, 0.05, 0.15], [2, 3]);
    ...
    it('2D - weighted - Reduction.MEAN', function () {
        ...
        var y = tf.losses.huberLoss(labels, predictions, weights, undefined, tf.Reduction.MEAN);
        expect(y.shape).toEqual([]);
        test_util_1.expectArraysClose(y, 0.011678572);
    });
    it('throws when passed label as a non-tensor', function () {
        var predictions = tf.tensor2d([0.1, 0.7, 0.1, 0.5, 0.05, 0.15], [2, 3]);
        var weights = tf.tensor2d([3, 6, 5, 0, 4, 2], [2, 3]);
...
jasmine_util_1.describeWithFlags('sigmoidCrossEntropy', test_util_1.ALL_ENVS, function () {
    it('All wrong', function () {
        ...
        expect(y.shape).toEqual([]);
        test_util_1.expectArraysClose(y, 6.6667123);
    });
    it('All right', function () {
        ...
        var y = tf.losses.sigmoidCrossEntropy(label, predictions);
        expect(y.shape).toEqual([]);
        test_util_1.expectArraysClose(y, 0);
    });
    it('Weighted - Reduction.SUM_BY_NONZERO_WEIGHTS', function () {
        ...
        expect(y.shape).toEqual([]);
        test_util_1.expectArraysClose(y, 1.3333424);
    });
    ...
    it('Weighted - Reduction.MEAN', function () {
        ...
        expect(y.shape).toEqual([]);
        test_util_1.expectArraysClose(y, 6.666712284088135);
    });
    it('Label Smoothing - Weighted - Reduction.MEAN', function () {
        ...
        expect(y.shape).toEqual([]);
        test_util_1.expectArraysClose(y, 6.1667128);
    });
...
jasmine_util_1.describeWithFlags('softmaxCrossEntropy', test_util_1.ALL_ENVS, function () {
    it('All wrong', function () {
        ...
        expect(y.shape).toEqual([]);
        test_util_1.expectArraysClose(y, 20);
    });
    it('All right', function () {
        var label = tf.tensor2d([[1, 0, 0], [0, 1, 0], [0, 0, 1]], [3, 3]);
        var predictions = tf.tensor2d([[10.0, -10.0, -10.0], [-10.0, 10.0, -10.0], [-10.0, -10.0, 10.0]], [3, 3]);
    ...
    it('Weighted - Reduction.SUM_BY_NONZERO_WEIGHTS', function () {
        ...
        expect(y.shape).toEqual([]);
        test_util_1.expectArraysClose(y, 4);
    });
    it('Weighted - Reduction.NONE', function () {
        var label = tf.tensor2d([[0, 0, 1], [1, 0, 0], [0, 1, 0]], [3, 3]);
        var predictions = tf.tensor2d([[10.0, -10.0, -10.0], [-10.0, 10.0, -10.0], [-10.0, -10.0, 10.0]], [3, 3]);
    ...
    it('Label Smoothing - Weighted - Reduction.MEAN', function () {
        ...
        expect(y.shape).toEqual([]);
        test_util_1.expectArraysClose(y, 18);
    });
    it('throws when multiClassLabels and logits are of different shapes', function () {
        var multiClassLabels = tf.tensor2d([10, 10, 10, 10, 10, 10, 10, 10, 10], [3, 3]);
        var logits = tf.tensor2d([10, 10, 10, 10, 10, 10], [2, 3]);
